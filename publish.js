...
folder.forEach((filename) => {
    ...
    fs.copyFileSync(resolve('htmls/' + filename), resolve('dist/htmls/' + filename))
    ...
    htmlReadmeMdFileSteam = htmlReadmeMdFileSteam + `- [${newFileName}](https://lidengkedev.github.io/example/htmls/${filename})\n`
